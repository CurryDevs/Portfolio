...
export const BentoGridItem = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group/bento shadow-input row-span-1 flex flex-col justify-between space-y-4 rounded-xl p-4 transition-all duration-300 lg:hover:shadow-2xl lg:hover:shadow-black/30 cursor-pointer",
        ...
        <div className="transition duration-200 group-hover/bento:translate-x-2 mt-auto">
          ...
          {href && cta && (
            <Button
              ...
              asChild
              size="sm"
              className="pointer-events-auto rounded-full px-4 py-2 text-xs w-fit"
            >
...
// Static skeleton components - no animations on mobile/tablet
const SkeletonMobile = () => {
  return (
    <div className="flex flex-1 w-full h-full min-h-[6rem] bg-transparent flex-col items-center justify-center space-y-2">
    ...
    <div className="flex flex-1 w-full h-full min-h-[6rem] bg-transparent flex-col items-center justify-center p-4 relative">
      <div className="grid grid-cols-3 gap-2 w-full max-w-32">
        ...
        <div className="bg-black border border-white/20 rounded-md p-2 flex flex-col items-center justify-center space-y-1">
          ...
          <div className="w-2 h-0.5 bg-gray-700 rounded-full" />
        </div>
        <div className="bg-black border border-white/20 rounded-md p-2 flex items-center justify-center">
          <div className="w-4 h-2 bg-gray-700 rounded-full relative">
            <div className="w-1.5 h-1.5 bg-gray-500 rounded-full absolute right-0.5 top-0.5" />
          </div>
        </div>
        <div className="bg-black border border-white/20 rounded-md p-2 flex items-center justify-center">
          <div className="w-3 h-3 bg-gradient-to-br from-gray-600 to-gray-700 rounded-full" />
        </div>
        <div className="bg-black border border-white/20 rounded-md p-2 flex items-center justify-center">
          <div className="w-3 h-1.5 bg-gray-600 rounded-full" />
        </div>
      </div>
