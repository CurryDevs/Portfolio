import {
  ...
  SiKubernetes, SiAmazonwebservices, SiGoogleanalytics, SiMixpanel, SiHotjar, SiAuth0, SiJsonwebtokens, SiSst, SiMdx, SiJavascript, SiHtml5, SiCss3, SiAstro, SiVercel, SiNextdotjs
} from "react-icons/si";
...
const iconMap = {
  ...
  SiAuth0, SiJsonwebtokens, SiSst, MdInstallMobile, MdSpeed, SiMdx, SiJavascript, SiHtml5, SiCss3, SiAstro, SiVercel, SiNextdotjs
};
